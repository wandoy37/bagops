...
<head>
    ...
    <title>BAG OPS - KOTA SAMARINDA | @yield('title')</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('sailor') }}/img/favicon.png" rel="icon">
...
<body>
    ...
    < <!--=======Footer=======-->
        <footer id="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-info">
                                <h3>BAGOPS POLRESTA SAMARINDA</h3>
                                <p>
                                    Jalan Samarinda Street <br>
                                    Nomor 535022, Samarinda<br><br>
                                    <strong>Phone:</strong> +62 821 4872 2747<br>
                                    <strong>Email:</strong> bagops@example.com<br>
                                </p>
                        ...
                        <div class="col-lg-2 col-md-6 footer-links">
                            ...
                            <ul>
                                ...
                                <li><i class="bx bx-chevron-right"></i> <a href="#">Pejabat Kepolisian</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4>Layanan Kami</h4>
                            <ul>
                                <li><i class="bx bx-chevron-right"></i> <a href="#">Pengaduan Masyarakat</a></li>
                                <li><i class="bx bx-chevron-right"></i> <a href="#">Pelayanan Lantar</a></li>
                                <li><i class="bx bx-chevron-right"></i> <a href="#">Pelayanan Reskrim</a></li>
                            </ul>
                        </div>

                        <div class="col-lg-4 col-md-6 footer-newsletter">
                            <h4>Subscribe</h4>
                            <p>Subscribe situs kami, agar anda mendapatkan notifikasi informasi terbaru melalui email
                            </p>
            ...
            <div class="container">
                <div class="copyright">
                    &copy; Copyright <strong><span>CircleDevOps</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
